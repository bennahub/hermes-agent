...
class TestBuildJobPromptWithScript:
    ...
    def test_script_output_injected(self, cron_env, monkeypatch):
        # This test owns prompt formatting; admission has independent production-seam coverage.
        monkeypatch.setattr(
            "cron.execution_scope.execute_job_action",
            lambda job, step, name, arguments, execute: execute(arguments),
        )
