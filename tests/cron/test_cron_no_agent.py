...
def test_run_job_no_agent_success_returns_script_stdout(hermes_env, migrate_configured_cron_job):
...
def test_run_job_no_agent_reloads_dotenv_before_script(hermes_env, monkeypatch, migrate_configured_cron_job):
...
def test_timed_out_no_agent_script_delivery_is_not_mislabeled_as_provider_failure(
    hermes_env, monkeypatch, migrate_configured_cron_job,
):
