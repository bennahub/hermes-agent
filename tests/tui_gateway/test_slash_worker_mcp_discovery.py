...
def test_profile_local_mcp_tool_is_visible_in_slash_worker(tmp_path):
    ...
    (profile_home / "config.yaml").write_text(
        yaml.safe_dump(
            {
                # This integration asserts the first snapshot after discovery;
                # the interactive 1.5s default may intentionally return early.
    ...
    try:
        ...
        try:
            ...
            pytest.fail("slash worker produced no /tools response within 15 seconds")
