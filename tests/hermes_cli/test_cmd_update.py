...
def _patch_gateway_discovery():
    ...
    """
    # The simulated checkout never replaces source; purging would discard these SDK/process fakes.
    with patch("hermes_cli.update_cmd._purge_stale_hermes_modules"), \
         ...
         patch("hermes_cli.update_inventory.collect_runtime_inventory",
               side_effect=lambda: __import__("hermes_cli.update_inventory", fromlist=["UpdatePlan"]).UpdatePlan()), \
