...
def test_oneshot_wires_session_db_for_recall(monkeypatch):
    ...
    class FakeAgent:
        def __init__(self, **kwargs):
            ...
            self.session_id = "oneshot-recall-fixture"
        ...
        def run_conversation(self, prompt, **_kwargs):
            ...
            original = consume_execution_source(self)
            assert original["instruction"] == prompt
            assert original["source"] == "cli.oneshot"
    ...
    # Retain the real config owner API used by native authority dependencies.
