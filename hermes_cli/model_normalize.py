...
# DeepSeek retired ``deepseek-chat`` / ``deepseek-reasoner`` after the 2026-07-24 cut-off.
# As of V4.1 Flash (2026-09-10), ``deepseek-flash`` is the canonical current model id;
# old V4 Flash ids are compatibility routes only.
