...
_OAUTH_PROVIDER_CATALOG: tuple[Dict[str, Any], ...] = (
    ...
    # Subscription sign-in stays external until an owner-only official-client
    # login and execution backend is integrated. Native login and API-key setup
    # are separate paths; this catalog does not claim subscription readiness.
    ...
    {"id": "claude-code", "name": "Claude subscription (official sign-in)",
     "flow": "external", "cli_command": "claude auth login",
