...
_SELF_CONTEXT_INTRO = (
    "The following is this job's last meaningful output. Quiet or failed runs do not replace it. Use it for "
...
def _build_job_prompt(
    ...
    if script_path:
        ...
        success, script_output = (
            prerun_script if prerun_script is not None else run_job_script_scoped(job, script_path))
