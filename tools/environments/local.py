...
def _finalize_child_env(env: dict) -> dict:
    ...
    from tools.terminal_execution_scope import apply_child_execution_scope
    env = apply_child_execution_scope(env)
...
class LocalEnvironment(BaseEnvironment):
    ...
    def _run_bash(self, cmd_string: str, *, login: bool = False, timeout: int = 120,
        ...
        from tools.terminal_execution_scope import register_foreground_process
        register_foreground_process(proc, self.cwd)
        if not _IS_WINDOWS:
