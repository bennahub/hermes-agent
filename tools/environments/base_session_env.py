...
_SNAPSHOT_EXCLUDED_ENV_REGEX = (
    ...
    "HERMES_CRON_SESSION|HERMES_EXECUTION_SCOPE|HERMES_BROWSER_CONTROL_)")
...
def _export_dump_excluding_session_vars(tmp_path: str, excluded_names: Iterable[str] = ()) -> str:
    ...
    return (
        ...
        "AI_AGENT HERMES_AGENT HERMES_EXECUTION_SCOPE "
...
def _wrap_command_script(
    ...
    """
    # Execution authority is injected per invocation, never restored from history.
    # Save/restore also neutralizes snapshots written by the predecessor.
    passthrough_names = tuple(sorted(set(passthrough_names) | {"HERMES_EXECUTION_SCOPE"}))
