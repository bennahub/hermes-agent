...
def _execute_tool(function_name: str, function_args: Dict[str, Any], original_args: Dict[str, Any], ids: _CallIds,
    ...
    def _dispatch(next_args: Dict[str, Any]) -> Any:
        ...
        from tools.code_execution_identity import consume_request_identity
        return execute_scoped(
            function_name, next_args,
            lambda admitted_args: registry.dispatch(function_name, admitted_args, **dispatch_kwargs),
            turn_id=ids.turn_id,
            invocation_id=consume_request_identity() or ids.tool_call_id, registry=True,
        )
