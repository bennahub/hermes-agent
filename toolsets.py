...
_HERMES_CORE_TOOLS = [
    ...
    "todo_list", "memory",
    "session_search",
    "request_connection", "list_connections",
    "clarify",
    ...
    "computer_use",
    "computer_ensure", "computer_status", "computer_wake", "computer_observe", "computer_act",
]
...
TOOLSETS = {
    "connections": _ts("Request Owner-controlled native connection setup in chat", ["request_connection", "list_connections"]),
    "agent_computer": _ts("Profile-enabled durable AgentComputer tools; discovery does not create or wake a computer",
                          ["computer_ensure", "computer_status", "computer_wake", "computer_observe", "computer_act"]),
