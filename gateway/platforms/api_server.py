...
class APIServerAdapter(OpenAICompatRoutesMixin, BasePlatformAdapter):
    ...
    async def _prepare_session_chat(self, request: "web.Request") -> tuple:
        ...
        run_kwargs = dict(
            execution_source=original_request(user_message, source="api_session_chat"),
    ...
    async def _run_agent(
        ...
        confirmed_runtime_lock: bool = False, bind_declared_conversation: bool = False, execution_source=None) -> tuple:
