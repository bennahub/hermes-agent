...
class GatewaySlashCommandsMixin(
    ...
    async def _handle_background_command(self, event: MessageEvent) -> str:
        ...
        execution_source = None if getattr(event, "internal", False) else original_request(prompt, source="gateway_background", source_id=task_id)
        self._track_background_task(self._run_background_task(
            prompt, event.source, task_id, execution_source=execution_source,
