...
def _interrupt_session_turn(sid: str, session: dict, *, request_id: str | None = None) -> bool:
    ...
    with session["history_lock"]:
        ...
        # The queue these mints were for is being discarded, so drop the mints
        # too — otherwise a later turn on this session could claim authority
        # from a submission that was cancelled.
        try:
            from tools import owner_task_authority as _owner_authority
            _owner_authority.clear_pending_for_session([
