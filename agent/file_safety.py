...
_READ_DENIED_DIRS = (
    ("agent-computers",
     "is the Hermes Agent Computer store (managed browser identities) and cannot be read directly.",
     "is inside the Hermes Agent Computer store (managed browser identities) and cannot be read directly."),
    ("mcp-tokens",
