...
def _redact_compaction_text(text: Any) -> str:
    ...
    from agent.compaction_redaction import redact_compaction_text

    return redact_compaction_text(text or "")
...
Write only the summary body. Do not include any preamble or prefix."""
    ...
    def has_content_to_compress(self, messages: List[Dict[str, Any]]) -> bool:
        ...
        from agent.compaction_head_boundary import completed_head_boundary

        compress_start = self._align_boundary_forward(
            messages, completed_head_boundary(messages, self._protect_head_size(messages))
        )
